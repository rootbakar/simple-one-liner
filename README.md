...
### Command 4:
```bash
echo "labs.p1.hol.es" | nuclei -t ~/nuclei-templates/http/exposed-panels
```
### Result:
...
### Command 5:
```bash
echo "labs.p1.hol.es" | nuclei -t ~/nuclei-templates/http/exposures
```
### Result:
...
### Command 6:
```bash
echo "labs.p1.hol.es" | nuclei -t ~/nuclei-templates/http/default-logins
```
```bash
echo "labs.p1.hol.es" | nuclei -t ~/nuclei-templates/default-login
```
### Result:
...
### Command 7:
```bash
echo "labs.p1.hol.es" | nuclei -t ~/nuclei-templates/http/vulnerabilities/wordpress
```
### Result:
...
### Command 8:
```bash
echo "labs.p1.hol.es" | nuclei -t ~/nuclei-templates/http/vulnerabilities/
```
### Result:
